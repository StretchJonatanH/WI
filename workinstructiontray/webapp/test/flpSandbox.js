		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#workinstructiontray-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workinstructiontray-display": {
								"semanticObject": "workinstructiontray",
								"action": "display",
								"description": "Dealing with work instructions for factory",
								"title": "Work Instructions",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workinstructiontray",
									"url": sap.ui.require.toUrl("workinstructiontray")
								}
							}
						}
					}
